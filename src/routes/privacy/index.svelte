<div class="py-10 text-gray-900 dark:text-gray-300">
	<main>
		<h1 class="text-2xl text-center">Privacy Policy</h1>
		<section class="px-5 sm:px-10">
			<p class="my-5 max-w-lg w-full mx-auto">
				Your privacy is important to us. It is <!-- -->twinter.so<!-- -->'s policy to respect your
				privacy regarding any information we may collect from you across our website, https://<!-- -->twinter.so<!-- -->,
			...
			<p class="my-5 max-w-lg w-full mx-auto">This policy is effective as of 15 May 2021.</p>
		</section>
	</main>
</div>
